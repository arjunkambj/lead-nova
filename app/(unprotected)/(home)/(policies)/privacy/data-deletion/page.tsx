  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto prose prose-default">
        <h1 className="text-3xl md:text-4xl font-bold text-default-900 mb-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            At LeadNova, we respect your privacy and provide you with the
            ability to delete your personal data. This page explains how you can
            request deletion of your data and what happens when you make such a
            request.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal pl-6 text-default-700 space-y-2">
            <li>
              <strong>In-App Request:</strong> Go to Settings → Privacy → Delete
              My Data
            </li>
            <li>
              <strong>Email Request:</strong> Send an email to
              privacy@leadnova.io with the subject &quot;Data Deletion
              Request&quot;
            </li>
            <li>
              <strong>Support Portal:</strong> Submit a request through our
              support portal at support.leadnova.io
            </li>
          </ol>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            Upon your request, we will delete the following data:
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            Certain data may be retained even after a deletion request for legal
            and operational purposes:
          </p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            <li>
              Transaction and billing records (retained for tax and accounting
              purposes)
            </li>
            ...
            <li>
              Backup data (will be deleted according to our backup retention
              schedule)
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            We process data deletion requests according to the following
            timeline:
          </p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            <li>
              <strong>Acknowledgment:</strong> Within 24 hours of receiving your
              request
            </li>
            <li>
              <strong>Verification:</strong> We may contact you to verify your
              identity (1-2 business days)
            </li>
            <li>
              <strong>Processing:</strong> Data deletion begins immediately
              after verification
            </li>
            <li>
              <strong>Completion:</strong> Most data deleted within 30 days
            </li>
            <li>
              <strong>Backup removal:</strong> Backup data deleted within 90
              days
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">Once your data is deleted:</p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            ...
            <li>
              Historical data from your previous account will not be available
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            Before requesting deletion, you may want to export your data. You
            can:
          </p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            ...
            <li>
              Request a complete data export by emailing privacy@leadnova.io
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-none text-default-700 space-y-2">
            <li>
              <strong>Email:</strong> privacy@leadnova.io
            </li>
            <li>
              <strong>Support Portal:</strong> support.leadnova.io
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            Data deletion is just one of your privacy rights. You also have the
            right to:
          </p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
