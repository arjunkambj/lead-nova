    ...
    <div className="min-h-screen pt-32 pb-20 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto prose prose-default">
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            LeadNova uses cookies for the following purposes:
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            <li>
              <strong>Meta/Facebook:</strong> For Facebook login and lead
              integration
            </li>
            <li>
              <strong>Google:</strong> For Google sign-in and analytics
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-default-700 space-y-2">
            ...
            <li>
              ...
              (typically 30 days to 1 year)
            </li>
            <li>
              <strong>Authentication Cookies:</strong> Valid for 30 days or
              until you sign out
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <p className="text-default-700">
              Most browsers allow you to refuse or delete cookies. Check your
          ...
          <div className="mb-4">
            ...
            <p className="text-default-700">
              You can manage your cookie preferences in your LeadNova account
              settings under Privacy → Cookie Preferences.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            LeadNova respects Do Not Track (DNT) browser settings. When DNT is
            enabled, we limit tracking to essential cookies only.
          </p>
        </section>
