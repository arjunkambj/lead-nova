      ...
      <div className="max-w-4xl mx-auto prose prose-default">
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            By accessing or using LeadNova &apos;s services, you agree to be
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            LeadNova provides a lead management platform that integrates with
            Meta (Facebook/Instagram) to capture, manage, and track leads from
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">You agree not to:</p>
          <ul className="list-disc pl-6 text-default-700 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            ...
            basis. All payments are non-refundable except as required by law or
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            LeadNova and its original content, features, and functionality are
            owned by LeadNova Inc. and are protected by international copyright,
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            You retain all rights to your data. By using our service, you grant
            LeadNova a license to use, modify, and display your data solely for
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            To the maximum extent permitted by law, LeadNova shall not be liable
        ...
        <section className="mb-8">
          ...
          <p className="text-default-700 mb-4">
            You agree to indemnify and hold harmless LeadNova and its officers,
        ...
        <section className="mb-8">
          ...
          <ul className="list-none text-default-700 space-y-2">
            <li>Email: legal@leadnova.io</li>
            <li>Address: LeadNova Inc., Legal Department</li>
          </ul>
        </section>
      </div>
    </div>
