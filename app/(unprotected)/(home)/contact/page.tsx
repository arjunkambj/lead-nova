      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Input
            ...
            variant="bordered"
            startContent={<Icon icon="solar:chat-line-linear" className="text-default-400" width={18} />}
          ...
          <Button
            ...
            endContent={!isSubmitting && <Icon icon="solar:arrow-right-linear" width={20} />}
          >
            Send Message
          </Button>
        </form>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="inline-flex p-3 rounded-xl bg-primary-50/50 mb-4">
              <Icon icon="solar:phone-bold" className="text-primary" width={24} />
            </div>
