        ...
        {connectionStatus?.isConnected ? (
          <div className="space-y-4">
            ...
            <div className="flex justify-between pt-4">
              <Button color="danger" variant="flat" onPress={handleDisconnect}>
                Disconnect
              </Button>
          ...
          <div className="space-y-4">
            <p className="text-default-600">
              Connect your Facebook page to start receiving leads directly in
              LeadNova.
            </p>
            ...
            {selectedPages.map((page) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <Avatar
                    icon={
                      <Icon icon="solar:facebook-bold" width={16} height={16} />
                    }
                    size="sm"
                  />
                  <div>
          ...
          <div className="mt-4 p-3 bg-warning-50 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm text-warning-700">
                Currently, only one page can be connected at a time. Multi-page
                support coming soon!
              </p>
            </div>
          </div>
