...
export function LeadsPageContent() {
  ...
  const { filters, updateFilter, clearFilters, activeFilterCount } = useLeadFilters();
  ...
  const statsCards = stats ? [
    ...
    {
      title: "High Priority",
      value: stats.byPriority.find(p => p.priority === "high")?.count || 0,
      ...
      <div className="flex justify-between items-center">
              ...
              <DropdownMenu aria-label="Saved views">
                {views.map((view) => (
                  <DropdownItem key={view._id}>
                    {view.name}
                    {view.isShared && (
                      <Icon icon="solar:share-linear" className="ml-1 text-xs" />
                    )}
                  </DropdownItem>
                ))}
              </DropdownMenu>
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            endContent={
              activeFilterCount > 0 && (
                <Badge color="primary" size="sm">{activeFilterCount}</Badge>
              )
            }
          >
            Filters
          ...
          <Dropdown>
            ...
            <DropdownMenu aria-label="View options">
              ...
              <DropdownItem
                key="settings"
                startContent={<Icon icon="solar:settings-minimalistic-linear" />}
              >
                View settings
              </DropdownItem>
              <DropdownItem
        ...
        <CardBody className="p-0">
          ...
          {viewType === "calendar" && (
            <div className="p-8 text-center text-default-500">
              <Icon icon="solar:calendar-bold" className="text-6xl mx-auto mb-4" />
