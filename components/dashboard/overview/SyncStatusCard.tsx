...
const SyncStatusCard = memo(
  ({ syncStatus, prevSyncJobId }: SyncStatusCardProps) => {
    return (
          ...
          {syncStatus.currentJob ? (
            <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs text-default-500">
                    ...
                    <span className="font-mono">
                      {syncStatus.currentJob.processedLeads || 0} /{" "}
                      {syncStatus.currentJob.totalLeads} leads
                    </span>
                  </div>
                  <Progress
                    value={
              ...
              {syncStatus.currentJob.startedAt && (
                <div className="space-y-1">
                  ...
                  {Date.now() - syncStatus.currentJob.startedAt >
                    5 * 60 * 1000 && (
                    <Chip
                      size="sm"
                      color="warning"
            ...
            <div className="text-center py-4">
              ...
              {syncStatus.recentJobs.length > 0 &&
                syncStatus.recentJobs[0].completedAt && (
