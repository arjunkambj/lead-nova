...
const features = [
  ...
  },
  {
    ...
    description: "Track lead performance, conversion rates, and team productivity with comprehensive dashboards",
    size: "wide",
  },
  {
    icon: "lucide:clock-3",
    title: "Historical Sync",
    description: "Import up to 90 days of past leads with our Business plan. Never lose valuable lead data.",
    size: "tall",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 space-y-20">
        ...
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-3 text-center">
          ...
          <p className="text-lg text-default-600 max-w-2xl">
            From lead capture to conversion, LeadNova provides all the tools you need to manage your Facebook leads effectively.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="lg:w-8/12 flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="sm:w-1/2 bg-content1 border border-divider rounded-2xl p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="text-xl font-semibold mb-2 text-default-900">{features[0].title}</h3>
                <p className="text-sm text-default-600">{features[0].description}</p>
                <div className="mt-6 flex gap-2">
                  <Icon icon="ri:facebook-fill" className="text-default-400" width={24} />
                  <Icon icon="ri:instagram-fill" className="text-default-400" width={24} />
                </div>
              </div>
              ...
              <div className="sm:w-1/2 bg-content1 border border-divider rounded-2xl p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="text-xl font-semibold mb-2 text-default-900">{features[1].title}</h3>
                <p className="text-sm text-default-600">{features[1].description}</p>
                <div className="mt-6">
            ...
            <div className="bg-content1 border border-divider rounded-2xl p-8 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-default-900">{features[3].title}</h3>
              <p className="text-sm text-default-600 mb-6">{features[3].description}</p>
          ...
          <div className="lg:w-4/12">
            <div className="h-full bg-content1 border border-divider rounded-2xl p-8 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-default-900">{features[4].title}</h3>
              <p className="text-sm text-default-600 mb-6">{features[4].description}</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-medium text-default-900">Today</p>
              ...
              <div className="mt-8 p-4 bg-content2 rounded-xl">
                <div className="flex items-center gap-2 mb-3">
                  <Icon icon="lucide:users" className="text-default-600" width={18} />
                  <h4 className="text-sm font-medium text-default-900">Team Collaboration</h4>
                </div>
